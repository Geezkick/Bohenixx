...
const ecosystem = [
  ...
  { id: "bxsocialproof", name: "BX Social Proof", desc: "Collect video and text testimonials from your customers and display them anywhere with a beautiful, embeddable 'Wall of Love'.", icon: "/bohenixx.png", color: "#B14CFF", href: "/dashboard/testimonials", price: "Starter", status: "Active" },
  { id: "bxinvoices", name: "BX Invoices", desc: "Automate your billing. Create beautiful invoices, set up automatic payment reminders, and get paid faster.", icon: "/bohenixx.png", color: "#B14CFF", href: "/dashboard/invoices", price: "Free", status: "Active" },
  { id: "bxscheduler", name: "BX Scheduler", desc: "The smartest way to manage your time. Let clients book appointments instantly with a customized booking portal.", icon: "/bohenixx.png", color: "#B14CFF", href: "/dashboard/appointments", price: "Free", status: "Active" },
];
