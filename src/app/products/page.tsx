...
const ecosystem = [
  { id: "bxpos", name: "BX POS", desc: "An advanced AI-integrated point-of-sale and inventory system optimized for healthcare, pharmacies, and clinics. Features real-time AI drug interaction warnings, predictive stock forecasting, and seamless medical billing.", icon: "/bohenixx.png", color: "#B14CFF", href: "/dashboard/pos", price: "Enterprise", status: "Active" },
